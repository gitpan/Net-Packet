#
# $Id: TypeDeviceId.pm,v 1.1.2.2 2006/11/12 18:21:35 gomor Exp $
#
...
sub print {
   ...
   my $i = $self->is;
   my $l = $self->layer;
   sprintf "$l: $i: type:0x%02x  length:0x%02x\n".
           "$l: $i: deviceId:%s",
...
Net::Packet::CDP::TypeDeviceId - Cisco Discovery Protocol extension header
